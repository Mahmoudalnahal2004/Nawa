    ...
    return (
      <div key={node.id} className={depth === 0 ? "pt-2" : "mt-1"}>
        <div 
          ...
          className={`flex items-center justify-between px-3 py-1.5 rounded-lg cursor-pointer transition-colors group ${isSelected ? 'bg-rose-500/20 text-rose-400' : 'text-gray-300 hover:bg-white/5'}`}
        >
