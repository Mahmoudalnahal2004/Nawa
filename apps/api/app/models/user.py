...
class User(Base):
    ...
    supabase_user_id: Mapped[str | None] = mapped_column(String(255), unique=True, nullable=True, index=True)
    ...
    quota_id: Mapped[int | None] = mapped_column(
        Integer,
        ForeignKey("quotas.id", ondelete="SET NULL"),
        nullable=True,
        default=None,
    )
